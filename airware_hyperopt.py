...
def split_model_3(x_train, x_test, y_train, y_test, param_list):
    ...
    x = concatenate([image_x, ir_x])
    x = Dense(200, activation='relu', kernel_initializer='he_normal',
              kernel_regularizer=l2_val)(x)
    x = Dense(100, activation='relu', kernel_initializer='he_normal',
              kernel_regularizer=l2_val)(x)
    x = Dense(50, activation='relu', kernel_initializer='he_normal',
              kernel_regularizer=l2_val)(x)
